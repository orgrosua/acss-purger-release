...
class License extends AbstractApi implements ApiInterface
{
    ...
    private function store(WP_REST_Request $wprestRequest) : WP_REST_Response
    {
        ...
        $old_license = \get_option(\ACSS_PURGER_OPTION_NAMESPACE . '_license', ['key' => '', 'opt_in_pre_release' => \false]);
        ...
        \update_option(\ACSS_PURGER_OPTION_NAMESPACE . '_license', ['key' => $new_license_key, 'opt_in_pre_release' => \false]);
